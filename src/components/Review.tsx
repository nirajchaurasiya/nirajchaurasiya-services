...
export default function Review() {
  return (
    <section className="text-gray-600 body-font pb-24">
      <div className="container px-5 mx-auto xl:w-3/4">
        <h1 className="text-3xl font-medium title-font text-gray-300 mb-12 text-center">
          Testimonials (What others say?)
        </h1>
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full border border-gray-800 p-8 rounded">
              <svg
              ...
              <p className="leading-relaxed mb-6 text-gray-100">
                Affordable and Exceptional! NKC Web Development delivered
                outstanding results within my budget. <br />
